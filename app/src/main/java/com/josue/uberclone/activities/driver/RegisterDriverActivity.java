...
import com.josue.uberclone.providers.DriverProvider;
...
public class RegisterDriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyToolbar.show(RegisterDriverActivity.this,"Registro de conductor", true);
    ...
    private void clickRegister() {
        ...
        final String vehiclebrand = mTextInputEmail.getText().toString();
        final String vehicleplate = mTextInputEmail.getText().toString();
